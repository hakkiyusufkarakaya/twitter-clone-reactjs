    ...
    return (
        <Popover className={'relative'}>
            <Popover.Button className={'block group outline-none'}>
                <div
                    className={'p-3 rounded-full inline-flex transition-colors items-center gap-5 group-hover:bg-[#eff3f41a]'}>
            ...
            <Popover.Panel
                className={'rounded-xl w-[318px] absolute bottom-0 left-0 bg-black shadow-box overflow-hidden'}>
                <button
                    className={'px-4 h-14 w-full inline-flex transition-colors items-center gap-5 hover:bg-[#eff3f41a]'}>
                    <svg viewBox="0 0 24 24" width={26.25} height={26.25} className={'block'}>
                        <path
                            fill={'#e7e9ea'}
                    ...
                    <div className={'text-xl pr-4 fond-bold'}>
                        Yer işaretleri
                    </div>
                </button>
                <button
                ...
                <div className={'h-px bg-[#2f3336] w-[89%] my-05 mx-auto'} />
                <Disclosure>
                    {({open}) => (
                        <>
                            <Disclosure.Button
                                className="h-[52px] flex justify-between w-full items-center px-4 font-bold hover:bg-[#eff3f41a] transition-colors">
                            ...
                            <Disclosure.Panel>
                                <Link to={'/'}
                                      className={'h-11 flex justify-start gap-3 px-3 w-full items-center hover:bg-[#eff3f41a] transition-colors text-[15px] font-medium'}>
